...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Zloz multisource dataset adaptacyjny do fine-tuningu modelu globalnego."
    )
    parser.add_argument(
        "--spec",
        type=Path,
        default=Path("global_adaptation_sources.yaml"),
...
def main():
    ...
    output_dir_value = args.output_dir or settings.get("output_dir", "data/global_adaptation")
    ...
    print(f"Zapisano dataset adaptacyjny modelu globalnego: {output_dir}")
