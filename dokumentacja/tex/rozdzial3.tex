...
\begin{itemize}
    \item wyselekcjonowany zbiór portretów do treningu modelu twarzowego,
...
\begin{tabular}{|L{3.3cm}|L{2.9cm}|L{2.9cm}|L{3.1cm}|}
\hline
...
\hline
Model twarzowy & \texttt{ConvNeXt Tiny} & Wybrane portrety i cropy twarzy & Ocena, czy analiza twarzy poprawia klasyfikację portretów. \\
\hline
