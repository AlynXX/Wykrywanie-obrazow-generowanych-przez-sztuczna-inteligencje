...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{../reports/gradcam_smoke_test.jpg}
\caption{Przykładowa wizualizacja Grad-CAM wygenerowana dla modelu globalnego}
\label{fig:gradcam-smoke}
\end{figure}

Wizualizacja Grad-CAM z rysunku \ref{fig:gradcam-smoke} pełni funkcję diagnostyczną. Pozwala sprawdzić, czy model opiera decyzję na istotnych obszarach obrazu, czy raczej reaguje na przypadkowe tło, kompresję albo inne artefakty niezwiązane bezpośrednio z twarzą lub głównym obiektem.
